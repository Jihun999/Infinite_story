...
from infinity.models.basic_batch_story import flash_attn_func, flash_fused_op_installed, AdaLNBeforeHead, CrossAttnBlock, SelfAttnBlock, CrossAttention, FastRMSNorm, precompute_rope2d_freqs_grid
...
class TextAttentivePool(nn.Module):
    ...
    def forward(self, ca_kv, infer_args):
        return self.ca(None, ca_kv, infer_args).squeeze(1)
